...
public class c5_CreatingSequence {
    ...
    public void potentially_null_mono() {
        ...
        Mono<String> potentiallyNullMono = Mono.justOrEmpty(null); //todo change this line only
    ...
    public void acknowledged() {
        Mono<String> acknowledged = Mono.fromSupplier(() -> null); //todo: change this line only
    ...
    @Test
    public void range() {
        Flux<Integer> range = Flux.range(-5, 5); //todo: change this line only
    ...
    public void repeat() {
        ...
        Callable<Integer> callable = () -> counter.getAndIncrement();
        Flux<Integer> repeated =  Mono.fromCallable(callable).repeat(9).map(i -> i+1);//todo: change this line
